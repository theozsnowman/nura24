...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light py-3">
            <div class="container">
                ...
                <a href="{{ route('homepage', ['lang' => $lang]) }}" class="navbar-brand">
                    <img src="{{ image($config->logo_auth ?? $config->logo) }}" alt="{{ $site_short_title }}">
                </a>
    ...
    <div class="container">
        ...
        <div class="alert alert-danger">
            ...
            @if ($message=='invalid_license_key') <b>{{ __('Invalid license key. Please contact system administrator') }}</b> @endif
        </div>
        @endif
        ...
        <div class="row py-5 mt-4 align-items-center">
            ...
            <div class="col-md-5 pr-lg-5 mb-5 mb-md-0 text-center">
                <img src="https://amail.app.param.ai/static/assets/img/illustrations/login.svg" alt="{{ __('Account login') }}" class="img-fluid mb-3 d-none d-md-block">
            </div>
