...
<div class="card-body">
	...
	<nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-3">
            ...
            <li class="breadcrumb-item active">{{ __('Product images') }}</li>
        </ol>                                
	</nav>
	...
	<span class="pull-right mb-3"><button data-toggle="modal" data-target="#create_product_image" class="btn btn-primary"><i class="fas fa-plus-square"></i> {{ __('Add image') }}</button></span>
	@include('admin.cart.modals.create_product_image')
		...
		<table class="table table-bordered table-hover">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<div class="d-flex">
							<form method="POST" action="{{ route('admin.cart.product.images.delete', ['image_id' => $image->id, 'id' => $id]) }}">
								{{ csrf_field() }}
								{{ method_field('DELETE') }}
