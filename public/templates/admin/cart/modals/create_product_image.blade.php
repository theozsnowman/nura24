...
?>
<div class="modal fade custom-modal" tabindex="-1" role="dialog" aria-labelledby="create_product_image" aria-hidden="true" id="create_product_image">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="validatedCustomFile" name="image" aria-describedby="fileHelp" required>
