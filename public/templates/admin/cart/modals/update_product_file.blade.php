...
?>
<div class="modal fade custom-modal" tabindex="-1" role="dialog" aria-labelledby="update_product_file_{{ $file->id }}" aria-hidden="true" id="update_product_file_{{ $file->id }}">
    <div class="modal-dialog">
        <div class="modal-content">

            <form action="{{ route('admin.cart.product.files', ['id' => $product->id, 'file_id' => $file->id]) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
