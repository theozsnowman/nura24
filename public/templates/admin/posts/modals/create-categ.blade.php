...
?>
<div class="modal fade custom-modal" tabindex="-1" role="dialog" aria-labelledby="creat-categ" aria-hidden="true" id="create-categ">
        ...
        <div class="modal-content">
            ...
            <form method="post">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="create-categ">{{ __('Create category') }}</h5>
