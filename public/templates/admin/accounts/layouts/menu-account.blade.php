<nav class="nav nav-tabs" id="myTab" role="tablist">
    ...
    <a class="nav-item nav-link @if ($menu_section=='tickets') active @endif" href="{{ route('admin.account.tickets', ['id' => $account->id]) }}"><i class="fas fa-ticket-alt" aria-hidden="true"></i> {{ __('Support Tickets') }} </a>     
    @endif
    @endif
