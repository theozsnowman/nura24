...
<div class="card-body">
	...
	<span class="float-right mb-3"><button data-toggle="modal" data-target="#create-categ" class="btn btn-primary"><i class="fas fa-plus-square"></i> {{ __('Create category') }}</button></span>
	...
	<div class="table-responsive-md">
		...
		<table class="table table-bordered table-hover">
			<thead>
				<tr>
					<th>{{ __('Details') }}</th>
					<th width="220">{{ __('Topics style') }}</th>
