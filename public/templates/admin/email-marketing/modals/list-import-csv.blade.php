...
?>
<div class="modal fade custom-modal" tabindex="-1" role="dialog" aria-labelledby="list-import-csv" aria-hidden="true" id="list-import-csv">
        ...
        <div class="modal-content">
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-dark"><i class="fas fa-share"></i> {{ __('Create') }}</button>
                </div>
