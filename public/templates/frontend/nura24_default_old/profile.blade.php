...
<head>
    ...
    <title>{{ $user->name }} - {{ lang_meta()->site_short_title }}</title>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div>
                                @if($user->avatar) <img src="{{ thumb($user->avatar) }}" alt="{{ $user->name }}" class="img-fluid rounded-circle float-left mr-3" style="max-height: 60px;">@endif
