<div class="account-header">
    <h3><i class="fas fa-user"></i> {{ __('Profile') }}</h3>
</div>
<!-- end card-header -->
...
<form method="post" enctype="multipart/form-data" action="{{ route('user.profile', ['lang' => $lang]) }}">
    ...
    <button type="submit" class="btn btn-primary"><i class="fas fa-user"></i> {{ __('Update profile') }}</button>
