...
class ForumController extends Controller
{
    ...
    {        
        ...
        $this->categories = Forum::whereNull('parent_id')->where('active', 1)->with('childCategories')->select('forum_categ.*')->orderBy('position', 'asc')->get();  
    }
    ...
    */
    ...
    {         
        if(! check_module('forum')) return redirect('/');        

        return view('frontend/'.$this->config->template.'/forum', [
    ...
    */
    ...
    {                 
        ...
        $categ_topics = DB::table('forum_topics')
            ...
            ->select('forum_topics.*', 'users.name as author_name', 'users.email as author_email', 'users.avatar as author_avatar', 'users.slug as author_slug', 
        ...
        return view('frontend/'.$this->config->template.'/forum-categ', [                                 
            'categ' => $categ, 
    ...
    */
    ...
    {         
        if(! check_module('topic')) return redirect('/');        
        ...
        return view('frontend/'.$this->config->template.'/forum-topic', [         
            'categ' => $categ,    
            'topic' => $topic,    
            'posts' => $posts,    
        ]);
    ...
    */
    ...
    {         
        ...
        return view('frontend/'.$this->config->template.'/forum-new-topic', [           
            'categ_id' => $categ_id,
            'categories' => $this->categories
        ]);
    }
    ...
    */
    public function store_topic(Request $request)
    {
        ...
        DB::table('forum_topics')->insert([
            ...
            'slug' => $slug = Str::slug($inputs['title'], '-'),
    ...
    */
    ...
    {          
        ...
        return view('frontend/'.$this->config->template.'/forum-report', [           
            'type' => $type,
            'topic' => $topic ?? null,
            'post' => $post ?? null,
            'id' => $id,            
